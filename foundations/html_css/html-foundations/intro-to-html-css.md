...
1. Read [HTML vs CSS vs JavaScript](https://web.archive.org/web/20230515001844/https://brytdesigns.com/html-css-javascript-whats-the-difference). It's a quick overview of the relationship between HTML, CSS, and JavaScript.
